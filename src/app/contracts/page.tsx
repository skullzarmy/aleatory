    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-8">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
                Everything this platform runs on, read from the router in your browser
                and linked to a block explorer. Retired contracts are listed too: a
                collection an old factory made is still owned by the artist who made
                it, and an old marketplace still holds the offers escrowed on it.
            </p>
            ...
            <section className="mt-12 rounded-lg border border-border p-6">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                    Every address above comes from the router&apos;s storage and its
                    history, which anyone can read without asking us. The queries this
                    page makes are in{" "}
                    <a
                    ...
                    describes what each contract has to do, so a piece resolves from
                    chain state whether or not this site is running.
                </p>
            </section>
        </div>
    );
